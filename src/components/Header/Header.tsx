    ...
    <header>
      <div className="header-container">
        ...
        <div className="header-content">
          ...
          <a href="tel:0800 887 637" className="phone-number"><img src={PhoneIcon} className="phone-icon"/></a>
          <a href="" className="find-us"><img src={LocationOnIcon} className="location-icon"/></a>
        </div>
      </div>
